...
const Navigation = (props:NavProps) => {
    ...
    return(
        <div id='nav' class='flex flex-row w-full md:w-full px-5 md:justify-between h-16 md:h-20 bg-[#171717] border-b-[1px] border-solid border-b-white/[0.15] md:py-4 md:px-16 md:gap-6 items-center justify-between' >
    ...
    <div id='centerForms' class='flex flex-row items-center gap-2 md:justify-between w-auto md:w-2/4 md:px-8' >
       ...
       <div class="md:hidden" onClick={()=> setSearchBar(!showSeachBar())}>
        <svg width="28" height="28" viewBox="0 0 32 32" fill="none" xmlns="https://www.w3.org/2000/svg">
