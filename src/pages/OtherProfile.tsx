...
const OtherProfile =()=> {
  ...
  createEffect(() => {
    ...
    instance.get(`http://localhost:8000/api/users/${path[2]}`).then((theUser)=> {
        setUserData({
        ...
        instance.get(`http://localhost:8000/api/users/${theUser.data.data.user.ID}/posts`).then((thePosts)=> {
    ...
    instance.get("http://localhost:8000/api/users/me",).then((theMe)=> {
      ...
      instance.get(`http://localhost:8000/api/users/${me()}/following`).then((res)=> {
    ...
    instance.get(`http://localhost:8000/api/users/${path[2]}/following`).then((res)=> {
      setUFollowing(res.data)
   
    })

    instance.get(`http://localhost:8000/api/users/${path[2]}/followers`).then((res)=> {
