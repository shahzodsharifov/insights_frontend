...
const OtherProfile =()=> {
  ...
  createEffect(() => {
    ...
    instance.get(`https://13.49.228.160443/api/users/${path[2]}`).then((theUser)=> {
        setUserData({
        ...
        instance.get(`https://13.49.228.160443/api/users/${theUser.data.data.user.ID}/posts`).then((thePosts)=> {
    ...
    instance.get("https://13.49.228.160443/api/users/me",).then((theMe)=> {
      ...
      instance.get(`https://13.49.228.160443/api/users/${me()}/following`).then((res)=> {
    ...
    instance.get(`https://13.49.228.160443/api/users/${path[2]}/following`).then((res)=> {
      setUFollowing(res.data)
   
    })

    instance.get(`https://13.49.228.160443/api/users/${path[2]}/followers`).then((res)=> {
