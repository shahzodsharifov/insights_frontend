...
const OtherProfile =()=> {
  ...
  createEffect(() => {
    ...
    instance.get(`https://api.noted.today/api/users/${path[2]}`).then((theUser)=> {
        setUserData({
        ...
        instance.get(`https://api.noted.today/api/users/${theUser.data.data.user.ID}/posts`).then((thePosts)=> {
    ...
    instance.get("https://api.noted.today/api/users/me",).then((theMe)=> {
      ...
      instance.get(`https://api.noted.today/api/users/${me()}/following`).then((res)=> {
    ...
    instance.get(`https://api.noted.today/api/users/${path[2]}/following`).then((res)=> {
      setUFollowing(res.data)
   
    })

    instance.get(`https://api.noted.today/api/users/${path[2]}/followers`).then((res)=> {
